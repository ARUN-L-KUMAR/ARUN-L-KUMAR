...
Hey! I'm a passionate **AI-Augmented Full Stack Developer** who loves turning ideas into impactful web solutions. I specialize in building **scalable, intelligent, and user-centric applications** that make a difference.

- 🎓 **CSE Student** at University College of Engineering, Kanchipuram (CGPA: 8.0)
- 💼 **Frontend Developer Intern** at Tripxplo
- 🤖 Passionate about **AI-assisted development** and automation
- 🌐 Building everything from **e-commerce platforms** to **blockchain DApps**
- 🎨 Combining **code & design** to create beautiful user experiences
- 🌱 Currently exploring **advanced AI workflows** and **Web3 technologies**
...
<p>
  ...
  <img src="https://img.shields.io/badge/CrewAI-000000?style=for-the-badge&logo=ai&logoColor=white" />
</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <strong>Tech Stack:</strong> React, Node.js, MongoDB, Socket.IO<br>
        Real-time e-commerce platform with admin dashboards, authentication, wishlist, order tracking, and live notifications.
      </p>
    </td>
    <td width="50%">
      ...
      <p align="center">
        <strong>Tech Stack:</strong> Solidity, Hardhat, React, IPFS<br>
        Decentralized funding platform on Ethereum with wallet integration, NFT minting, and smart contract transactions.
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <strong>Tech Stack:</strong> Python, TensorFlow, Computer Vision<br>
        AI-powered crop disease detection system trained on 7,000+ plant images with advanced data augmentation.
      </p>
    </td>
    <td width="50%">
      ...
      <p align="center">
        ...
        Complete mobile app UI with 15+ screens, wireframes, color palette, and comprehensive style guide for agritech platform.
      </p>
    </td>
  </tr>
</table>
...
**Frontend Developer Intern @ Tripxplo** *(Apr 2025 - Jul 2025)*
- Built Quote Generator and CRM modules using **ReactJS** and **Tailwind CSS**
- Integrated frontend with **Supabase** and **REST APIs** for dynamic data handling
- Collaborated across design and backend teams on digital campaigns
...
- **Full Stack Web Development** - NoviTech R&D Pvt Ltd
- **Front-End and Web Development** - IBM (Coursera)
- **AI & Data Analytics Internship** - AICTE, Shell & Edunet Foundation

---

## 🌱 Currently Learning

- Advanced AI workflow automation with **CrewAI** and **n8n**
- Scaling **Web3 applications** and **DeFi protocols**
...
<p align="center">
  I'm always excited to collaborate on innovative projects or discuss tech, AI, and blockchain! Feel free to reach out:
</p>
